...
<div class="banner-home" id="img-banner">    
  <div class="row v-center">
    <h2>Nós conectamos os geradores de resíduos aos principais tratadores e fornecedores do Brasil. E o melhor: sem custo para você!</h2>
...
<div class="bgcolor-grey">
  <div class="row p-t-50 p-b-50">  
    <div class="small-12 medium-12 large-5 columns text-justify">
      ...
      <div class="p-t-20">
        <a class="botao-conversao rowfull text-center" data-toggle="animatedModal-proposta-vg-residuos">TESTAR GRÁTIS O VG RESÍDUOS</a>
      </div>
    </div>
...
<div class="row p-b-50 p-t-30 p-t-c p-b-c text-center">
  ...
  <div class="large-4 columns">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/dashboard.png" alt="dashboard Plataforma Gestão Resíduos" />
    <h3>Dashboard</h3>
  ...
  <div class="large-4 columns">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/mercado-residuos.png" alt="mercado dos resíduos" />
  ...
  <div class="large-4 columns">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/relatorios.png" alt="relatórios da Plataforma de Gestão de Resíduos" />
    <h3>Relatórios</h3>
